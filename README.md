...
> [!NOTE]
> 기본 모델은 `Qwen/Qwen3-8B`이며, 실행 환경의 자원이 부족한 경우 `Qwen/Qwen3-4B-Instruct-2507`로 사용자가 직접 대체해 사용하는 것을 권장합니다.
...
| `Qwen/Qwen3-4B-Instruct-2507` | Apache-2.0 | 자원 부족 시 대체 모델로 사용 권장 |
