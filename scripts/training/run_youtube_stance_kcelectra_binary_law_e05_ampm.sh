...
SEED="${SEED:-42}"
RUN_ID="${RUN_ID:-$(TZ=Asia/Seoul date +%Y%m%d_%H%M%S_KST)_E05_seed${SEED}}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/outputs/youtube_stance_kcelectra_binary_law_cv5_e3/${RUN_ID}}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-youtube-stance-kcelectra-binary-law-original-cv5-e3}"
EXPERIMENT_NOTE="${EXPERIMENT_NOTE:-E05}"
